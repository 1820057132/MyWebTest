 ...
 */
@WebServlet("/needLogin/myInfoJs")
public class GetMyInfoJsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       /* req.setAttribute("IDCard",userBean.getIDCard());
        ...
        userBean.setNickName("hello servlet");
        resp.getWriter().print(JSONObject.toJSONString(userBean));
    }
}
